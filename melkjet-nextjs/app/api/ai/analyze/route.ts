...
export async function POST(req: NextRequest) {
  ...
  const system = `تو کارشناس املاک ملک‌جت هستی. این آگهی را تحلیل کن و مشخصات کلیدی را از متن استخراج کن. فقط یک JSON معتبر برگردان (بدون متن اضافه) با این ساختار:
{"facts":[{"label":"متراژ","value":"۴۵۰ متر"},{"label":"اتاق","value":"۳"},{"label":"سال ساخت","value":"۱۴۰۲"},{"label":"طبقه","value":"۵"},{"label":"پارکینگ","value":"۱۰"}],"amenities":["آسانسور","پارکینگ","انباری"],"summary":"خلاصه ۲ تا ۳ جمله‌ای فارسی","pros":["مزیت ۱","مزیت ۲","مزیت ۳"],"cons":["نکته ۱","نکته ۲"],"scores":{"ارزش خرید":8.5,"کیفیت ساخت":8,"دسترسی":9,"محله":8.5,"سرمایه‌گذاری":8},"confidence":92}
در facts فقط مواردی که در متن آمده را بیاور (متراژ، تعداد اتاق/خواب، سال ساخت، طبقه، پارکینگ، ودیعه/اجاره، قیمت). amenities لیست امکانات ذکرشده. اعداد scores بین ۰ تا ۱۰ و confidence بین ۰ تا ۱۰۰.`

...
// باشد و الگوهای رایج متن هوش مصنوعی را نداشته باشد (ضدتشخیص).
const SYS = `تو یک نویسندهٔ ارشد و کارشناس بازار املاک ایران هستی که سال‌ها مقاله می‌نویسی. یک مقالهٔ فارسیِ کاملِ سئو-محور بنویس که **کاملاً انسانی** به نظر برسد و هیچ ابزار تشخیص هوش مصنوعی نتواند آن را ماشینی تشخیص دهد.
...
- ساختار سئو: یک H1، چند H2/H3، پاراگراف‌های کوتاه، فهرست‌های نقطه‌ای، و در صورت لزوم یک بخش پرسش‌وپاسخ (FAQ).
- کلمهٔ کلیدی اصلی را طبیعی در عنوان، اولین پاراگراف، چند زیرعنوان و متن پخش کن (نه پر از کلمهٔ کلیدی).
- طول مقاله حدود ۷۰۰ تا ۱۲۰۰ کلمه. متن را به‌صورت Markdown بنویس (## برای زیرعنوان، - برای فهرست، **بولد**).
...
export async function POST(req: NextRequest) {
  ...
  try {
    let text = await chatCompleteSafe(model, [{ role: 'system', content: SYS }, { role: 'user', content: user }], { temperature: 0.85, max_tokens: 3000 })

        ...
        {loading ? (
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 16, overflow: 'hidden' }}>
            ...
            <div style={{ maxHeight: 660, overflowY: 'auto' }}>
              {(refRows).map((r, i) => (
                <Link key={r.id} href={`/product/${r.id}`} className="mjn-r" style={{ display: 'grid', gridTemplateColumns: '2.4fr 1.2fr 1fr 0.9fr', padding: '11px 18px', borderBottom: i < refRows.length - 1 ? '1px solid var(--line)' : 'none', fontSize: 13, alignItems: 'center', textDecoration: 'none', color: 'inherit' }}>

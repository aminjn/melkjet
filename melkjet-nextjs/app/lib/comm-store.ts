...
function repriceChannel(channel: Channel, pricePerUnit: number, roundTo: number): number {
...
export function repriceTokenPackages(pricePerToken: number, roundTo = 1000): number { return repriceChannel('token', pricePerToken, roundTo) }
export function repriceSmsPackages(pricePerSms: number, roundTo = 1000): number { return repriceChannel('sms', pricePerSms, roundTo) }

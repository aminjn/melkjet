...
export async function importDivarToken(o: string, input: string, hint?: BrandPost, sourceId?: string, opts?: { publish?: boolean; skipFreshMs?: number; fetchPost?: typeof fetchDivarPost }): Promise<ImportResult> {
  ...
  const payload: Partial<Listing> = {
    ...
    nightlyWeekend: post.nightlyWeekend || undefined,
    nightlyHoliday: post.nightlyHoliday || undefined,
    extraPersonFee: post.extraPersonFee || undefined,
    capacityStd: post.capacityStd || undefined,
    capacityExtra: post.capacityExtra || undefined,

...
{"facts":[{"label":"متراژ","value":"۲۸۵ متر"},{"label":"اتاق","value":"۴"}],"amenities":["آسانسور","پارکینگ"],"summary":"خلاصه ۲ تا ۳ جمله‌ای فارسی","pros":["مزیت ۱","مزیت ۲","مزیت ۳"],"cons":["نکته ۱","نکته ۲"],"scores":{${scoreKeys}},"confidence":92,"priceTrend":{"values":[62,64,65,66,68,70,71,73,74,76,78,80],"yearGrowth":"۸٪","forecast":"ادامهٔ رشد ملایم"}}

...
// ─── فاز ۴۵ (سند ۲۹ — Auction Saga): تالارِ مزایدهٔ هفته ───
{
  ...
  const { worldYearOf, worldHeatOf, rumorsGen, resolveRumor, sourceTrustOf } = await import('../app/lib/empire-world.ts')
  ...
  ok('۵ مجموعهٔ سند تعریف شده‌اند', COLLECTIONS.length === 5)
